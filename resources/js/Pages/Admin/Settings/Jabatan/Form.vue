  ...
  <form @submit.prevent="submit()">
    <div class="flex flex-col space-y-4">
      ...
      <div v-if="form.tipe_user === 'Backend User'">
        ...
        <div v-for="module in userAccess" class="flex flex-col space-y-4 my-8">
      ...
      <div class="flex flex-row justify-end space-x-4">
        <Link class="py-3 px-6 text-center shadow-md rounded-md font-semibold text-white bg-gray-400 focus:outline-none focus:ring-4 focus:ring-gray-300 disabled:cursor-not-allowed" :href="route('admin.settings.jabatan.index')" :disabled="form.processing">
          Back
        </Link>
