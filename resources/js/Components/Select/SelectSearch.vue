<template>
  <div class="flex flex-col">
    <div class="relative">
      ...
      <svg v-show="clearable && modelValue && modelValue.length > 0" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-4 h-4 absolute right-8 top-3.5 cursor-pointer" viewBox="0 0 16 16" @click="clear()">
      ...
      <transition
        ...
        <div v-show="show" class="absolute w-full z-50 mt-2 shadow-lg origin-top border bg-white border-black rounded-md">
          ...
          <div v-show="dropdown.length === 0" class="py-2 px-4">No records to show.</div>
