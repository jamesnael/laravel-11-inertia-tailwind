...
<head>
    ...
    <title>Your Entry is Unpublished on ERIA’s Private Sector Platform</title>
    <style>
        a {
        ...
        <div class="portlet">
            ...
            <div class="portlet-content">
                ...
                <p style="margin-top: 0; font-size: 15px; padding-bottom: 8px;">
                    We hope this message finds you well. We regret to inform you that your entry, {{$data->title}}, has been unpublished by our admin.
                </p>
