...
<head>
    ...
    <title>Your Account has been Rejected by Admin</title>
    <style>
        a {
        ...
        <div class="portlet">
            ...
            <div class="portlet-content">
                ...
                <p style="margin-top: 0; font-size: 15px; padding-bottom: 8px;">
                    Your account has been Rejected by Admin,The reason for the rejection is :
                </p>
                ...
                <p style="margin-top: 0; font-size: 15px; padding-bottom: 8px;">
                    Please carry out your registration process again
                </p>

                <br>
                <a href="{{ route('frontend.registration') }}" target="_blank"
                    style="padding: 5px; border-radius:5px; color: #fff; background-color:#334E9E">
                    Register
                </a>
                <br>
                <br>
