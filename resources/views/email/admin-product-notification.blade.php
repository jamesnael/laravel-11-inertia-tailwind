        ...
        <div class="portlet">
            ...
            <div class="portlet-content">
                ...
                <p style="margin-top: 0; font-size: 15px; padding-bottom: 8px;">
                    A new product has been uploaded by {{$data->product_company->title}}. The details are as follows:
                </p>
                ...
                <p style="margin-top: 0; font-size: 15px; padding-bottom: 8px;">
                    Please review and take action to publish or approve the entry by logging into the admin panel.
                </p>

                <br>
                <center>
                    <a href="{{ route('admin.private-sector-platform.private-sector-product.edit', $data->slug) }}" target="_blank"
                        style="padding: 0.65rem 1rem; border-radius:5px; color: #fff; background-color:#334E9E">Update Approval
                        Status
                    </a>
                </center>
                <br>
