    ...
    <div class="body">
        ...
        <div class="portlet">
            ...
            <div class="portlet-content">
                <p style="margin-top: 0; font-size: 18px; padding-bottom: 8px;">Dear Administrators,</p>

                <p style="margin-top: 0; font-size: 15px; padding-bottom: 8px;">
                    The product ({{ $data->title }}) has been <b>Deleted</b> by {{ $data->product_creator->nama_lengkap }} at {{ date('d F Y H:i:s', time()) }}.
                </p>
