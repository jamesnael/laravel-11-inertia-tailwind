        ...
        <div class="portlet">
            ...
            <div class="portlet-content">
                ...
                <p style="margin-top: 0; font-size: 15px; padding-bottom: 8px;">
                    Thank you for registering your company ({{ $data->company->title }}) with ERIA’s Private Sector Platform! 
                </p>
                {{-- <p style="margin-top: 0; font-size: 15px; padding-bottom: 8px;">
                    This link will expire in 3 hours,if you fail to verify within 3 hours your account will be automatically deleted.
                </p> --}}
                <p style="margin-top: 0; font-size: 15px; padding-bottom: 8px;">
                ...
                <br>
                <center>
                    <a href="{{route('frontend.home.verify',['code'=>base64_encode($data->id)])}}" target="_blank"
                ...
                <a style="margin-top: 0; font-size: 15px; padding-bottom: 8px;" 
                    href="{{route('frontend.home.verify',['code'=>base64_encode($data->id)])}}">
                    {{route('frontend.home.verify',['code'=>base64_encode($data->id)])}}
                </a>

                <p style="margin-top: 0; font-size: 15px; padding-bottom: 8px;">
                    <i>Note: This link is only valid for the next 24 hours.</i>
                </p>
